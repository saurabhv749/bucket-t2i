...
from bucket_dataloader import generate_buckets, from_hub, build_dataloader 
...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=int,
        default=192,
        help="Minimum image dimension in pixels for image buckets.",
    )
    parser.add_argument(
        "--max_px",
        type=int,
        default=192,
        help="Maximum image dimension in pixels for image buckets.",
    )
    parser.add_argument(
        "--max_px_area",
        type=int,
...
def main():
    ...
    # Bucket dataset
    # ---------------------------------------------------------------------------
    buckets = generate_buckets(min_px=args.min_px, max_px=args.max_px, max_area=args.max_px_area)
    ...
    logger.info(f"  Num examples = {len(ar_bucket_ds)}")
